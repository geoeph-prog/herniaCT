...
import org.weasis.core.ui.tp.raven.datetime.TimeSelectionAble;
...
public class TimeSelectionModel {
  ...
  /** When hour unselected and user select the minute So we need set the default hour */
  ...
  /** Default hour can be disabled by timeSelectionAble Use this method to get the available hour */
  ...
  /**
   * When check time selection able but minute not set Use this for default minute to check the
   * available hour
   */
